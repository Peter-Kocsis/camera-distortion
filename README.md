...
```bash
pyinstaller --name media_undistorsion --add-data "./gui/camera_distorsion.ui;./camera_distorsion.ui" --add-data "./gui/icon.png;./icon.png" --hidden-import "pygubu.builder.tkstdwidgets" --hidden-import "pygubu.builder.ttkstdwidgets" --icon "./gui/icon.ico" --windowed --onefile ./gui/camera_distorsion_app.py
```
