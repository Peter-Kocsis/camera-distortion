"""
Tk drag and drop handler,
based on the implementation from https://stackoverflow.com/questions/14267900/drag-and-drop-explorer-files-to-tkinter-entry-widget
"""
import os
...
class TkDND(object):
    """
    Class for handling drag-and-drop into Tkinter applications
    ...
    def __init__(self, master):
        if not getattr(master, '_tkdnd_loaded', False):
            self._load_tkdnd(master)
        self.master = master
        self.tk = master.tk

    def _load_tkdnd(self, master):
